/*
Si scriva un programma C che all'interno del main consenta di inizializzare da tastiera un vettore di interi
...
int main()
{
    ...
    do
    { /* leggo la lunghezza che deve essere accettabile */
