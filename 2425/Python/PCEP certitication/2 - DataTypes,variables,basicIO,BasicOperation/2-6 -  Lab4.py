...
and prints the value of a variable named y. Your task is to complete the code in order to evaluate
...
each time assigning it to the x variable (by hardcoding it). Don't be discouraged
by any initial failures. Be persistent and inquisitive.
